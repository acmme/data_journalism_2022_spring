...
wv_ppp_loans %>% 
  ...
  summarize(
    ...
    percentage_forgiven = forgiveness_amount / total_loan_amount * 100
  ) %>% 
  summarize(
    total_total_loan_amount = sum(total_loan_amount),
    total_percentage_forgiven = sum(percentage_forgiven)
  )
