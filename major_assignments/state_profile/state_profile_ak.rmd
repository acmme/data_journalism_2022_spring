...
``` {r}
alaska_ppp <- read_csv("~/school/alaska_ppp/alaska_ppp.csv")

# The number of applications recorded in Alaska.

alaska_ppp %>% 
  summarize(
    number_of_applications = n()
  )

# The total amount of loan money distributed, as recorded in Alaska.

alaska_ppp %>% 
  summarize(
    total_amount_distributed = sum(current_approval_amount)
  )

# The total amount of loans distributed per county.
