...
**Answer** Tables that describe how the US Bureau of Labor Statistics classifies current employment.
...
**Answer** A long page of code in HTML.
...
**Answer** An HTML document with a head and body.
...
**Answer** An HTML document with a head and body and some "xml attributes."
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** <th class="stubhead" rowspan="1" id="NAICSsectors-0-0" role="columnheader">Sector</th>
...
**Answer** The different tables that exist on the Classification Overview page.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** A series of nested lists that contain the extracted tables.
...
**Answer** A table that shows the changes made to NAICS over time.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** A table that defines NAICS sectors.
...
**Answer** naics_industry is redefined as a table that consists of the sector data.
...
**Answer** Pulls up and cleans up the source table into a dataframe.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Information on the utilities sector.
...
**Answer** A slice of HTML that shows a table with a set of columns and rows.
...
**Answer** Six rows of employment data from the past four months.
...
**Answer** Only shows Nov 2021 employment numbers, seasonally adjusted.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Employment data on the Mining, Quarrying, and Oil and Gas Extraction sector.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Employment data on the Construction sector.
...
**Answer** Just prints the names of 10 sectors.
```{r}
...
**Answer** Created a column called 'list of sectors' that includes the names of the 10 sectors.
```{r}
...
**Answer** Prints the list of sectors column, showing all 10 names of the sectors.
```{r}
...
**Answer** No value called sector_list was established.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** No variable called sector_name was established.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** Prints numbers in order from 1 to 10.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** Shows the naics_industry dataframe.
...
**Answer** Counts the number of rows in naics_industry.
...
**Answer** Counts the number of rows one by one and prints them 1 through 20.
...
**Answer** Cleans up the mining data to just include the Nov 2021 employment numbers, seasonally adjusted.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** Pulls up and cleans up the sector and saves it as a dataframe.
```{r}
# Define url of page we want to scrape
...
**Answer** Creates a column that saves the URLs for each sector's employment data.
...
**Answer** Creates a column that IDs the employment data table for each sector.
...
**Answer** Public administration has been removed from the dataset.
...
**Answer** Several tables that isolates each sector's row.
...
**Answer** Prints the isoalted rows' URLs and IDs.
```{r}
...
**Answer** Pulls up the employment data of each sector and creates a table for each of them.
...
**Answer** Strips the employment data tables to just show the total employment for each of the last four months, seasonally adjusted.
...
**Answer** Includes the sector, description, URL and ID of each sector for each table of stripped employment data.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** Tables that isolate each sector and include columns for the sector number, description, and Nov 2021 total employment data, seasonally adjusted.
...
**Answer** Consolidates the Nov 2021 employment data for all of the sectors, except Public Administration.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The unemployment numbers for the agriculture sector.
...
**Answer** Removes the Nov 2021 employee data, but keeps the Agriculture row.
