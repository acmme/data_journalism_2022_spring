...
**Answer** The code is creating a data frame that only includes the 10 counties with the greatest amount of loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart that compares counties by their total loans.
...
**Answer** The bar chart is ordered from fewest to most loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The graph is flipped so that it is a horizontal bar graph.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The graph now has a white background.
...
**Answer** The background is blue and the font has changed.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The Y axis is labelled 'total loans' and the X axis is labelled 'county' (incorrectly).
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** It shows a dataframe that summarizes the total amount of loans per their approval date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A line graph that shows when loans were approved  up to July 2021.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The scale of the graph is broken down per month instead of per six months.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The X axis is slanted for visibility.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
