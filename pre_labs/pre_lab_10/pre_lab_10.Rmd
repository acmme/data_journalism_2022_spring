...
https://datawrapper.dwcdn.net/pRMKd/1/
...
The code created a dataset that lists how many loans there are per county in Maryland.
...
**Answer** Describe what the code below is doing and the output.
The code removes any small outliers from the county dataset.
...
5-digit FIPS codes with the Maryland county code (24)
...
A combination of the county-loan data with the FIPS code data.
...
Went from a map of the United States to a funky map of Maryland.
...
**Answer** Describe the changes from the previous map
Scrolling over each county now shows the name of the county and how many loans are associated with that county.
...
https://datawrapper.dwcdn.net/fJTsG/1/ 
