...
**Answer** A folder of shapefiles with the same name: Hospitals.
...
**Answer** A dataframe that includes location information about different hospitals, including whether it has a helipad and its longitude and latitude.
...
**Answer** 72 hospitals in Maryland and their identifying features, with the first 10 showing hospitals primarily located in Baltimore. Of the Maryland hospitals, they are primarily considered nonprofit, with a few of them government hospitals. A majority of them provide general acute care. Their geometry is defined by the minimum boundaries that encompass all 72 hospitals according to their latitude and longitude. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** 50 hospitals are general acute care, 11 psychiatric, 4 military, 2 chronic disease, 2 long-term care, 2 rehabilitation and 1 "special." The geometry for all of them is labelled <S3: sfc_GEOMETRY>
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This dataframe shows the 50 hospitals in Maryland that are considered general acute care. Their geometry is defined by the minimum boundaries that encompass all 50 hospitals according to their latitude and longitude. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A scatterplot that shows the location of hospitals in Maryland, mostly clustered in Baltimore.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Shapefile data for all US counties. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The counties dataframe is reduced to just Maryland counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A scatterplot of geographic coordinates of Maryland's counties' boundaries, which approximate the shape of Maryland (not including the Chesapeake Bay).
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The geographic coordinates of Maryland's hospitals superimposed over the Maryland "map."
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The hospitals' geographic coordinates are now in dark to light colors depending on the number of beds each hospital has.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a dataframe that includes Maryland's 50 general acute care hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe that arranges counties by how many beds they have in total in all of their hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A census dataframe that collected the population totals of Maryland's counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A census dataframe that collected the population totals and geographic coordinates of Maryland's counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe of Maryland's counties' populations and geography and a dataframe of the total beds in all hospitals per Maryland county, arranged from most to least.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** County columns are standardized and joined, estimate column is named population column.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Bed dataframe is joined with county population dataframe.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** NA data for beds is considered 0.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A column is created that determined the number of beds per 100,000 people per county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The counties are filled with dark to light colors according to how many beds each county has per 100,000 people.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The color is changed to the 'magma' option of color scales.
...
**Answer** The counties are colored on a logarithimic scale, rather than a linear scale. Now, it is easier to see that there are fewer beds per 100,000 people in central Maryland than in other counties, except for Baltimore. Rural counties and Baltimore have more beds per 100,000 people.
