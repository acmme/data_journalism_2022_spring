...
**Answer** The dataframe shows how many and what kind of vaccinations counties recorded each day.
...
**Answer** There's also 200 total vaccinations in an NA county. Besides that NA county, there are 25 counties listed, but Maryland has only 24 (including Baltimore City).
...
**Answer** The NA county also has incomplete data for what kind of vaccinations are being distribute each day.
...
**Answer** The numbers of fully vaccinated vaccinations are starting to drop.
...
**Answer** There was a rapid increase in early 2021 and has since declined, with small spikes following approvals in booster shots and shots for children.
...
**Answer** The chart compares Maryland county changes in number of cases. It shows each county increased cases proportionally, except for Unknown, which draw a random spike just before 2022.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** This chart shows a logarithmic scale of the earlier chart, and shows that the rate of increase and decrease of the unknown county is highly sporadic.
...
**Answer** The map shows a high amount of cases yesterday in highly populated areas, and a lower amount of cases in less densely populated areas of Maryland.
