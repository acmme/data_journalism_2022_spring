...
**Answer** Tweets from politicians, with each politician identified by their state, district, title, name and party.
...
**Answer** It reduces the list to its unique values, removing any duplicates. This is case sensitive.
...
**Answer** The function created a dataframe that includes all the words used in the covid_tweets dataframe, including duplicates. it removes end punctuation but keeps apostrophes.
...
**Answer** At this stage, the number of unique words isn't particularly interesting. The most common words are common English words, such as "the," "to" and "and." The most interesting words of the top 25 words are covid, covid19 and coronavirus, but these are value-neutral. Everyone was talkig about Covid since 2020.
...
**Answer** The most common words now are all related to COVID, COVID relief and vaccines. It's more interesting than before, but still value-neutral.
...
**Answer** Interestingly enough, the word crisis, likely in reference to the pandemic, pops up in the 2020 dataframe, but loses relevance in the 2021 dataframe, when politicians start focusing on words like "vaccine."
...
**Task** Run the following code and describe the results.
**Answer** The bigrams mostly refer to the COVID pandemic and a relief package. COVID-19 was clearly the biggest thing on anyone's mind, being 3 percentage points more frequent than any other bigram.
...
**Task** Run the following code and describe the results.
**Answer** In 2021, the idea of a COVID vaccine became a greater topic, accounting for at least 1 percent of all words politicians used in thier tweets.
...
**Task** Run the following code and describe the results.
**Answer** Democrats are more likely to refer to health care and public health in 2020, and are more likely to refer to the CARES act as "relief," while Republicans simply refer to it as the CARES Act.
...
**Task** Run the following code and describe the results.
**Answer** In 2020, Republican House candidates are more likely to refer to Donald Trump and nursing homes, as well as COVID. Interestingly, they also are more likely to say "God bless." 2021 Republican House candidates are instead more likely to refer to Joe Biden as well as "illegal immigrants." They are also significantly more likely to say "covid positive."
...
**Answer** The word "tough" has a positive sentiment, which might seem counter-intuitive. It's likely referring to strength as opposed to difficulty. Soft, however, also has a positive sentiment, which would be the case in sensory input or difficulty but not in strength.
